package com.android.chatdemo.contentprovider;
...
import com.android.chatdemo.db.DbOpenHelper;


/**
 * 描   述:  在initProvoder方法中，我们开启线程来对数据库进行操作，
 *              删除表的所有数据，再添加数据，并实现了query和insert方法
 * 创 建 人: gaodianjie
 * 创建日期: 2018/7/10 18:36
 */
public class GameProvider extends ContentProvider {
    public static final String AUTHORITY = "com.android.chatdemo.contentprovide.GameProvider";
